...
const emailWorker = require("./src/Redis/Worker/EmailWorkerNew");
...
const safeSpaceAuthRoutes = require("./src/Routes/SafeSpaceAuthRoutes");
const uploadRoutes = require("./src/Routes/UploadRoutes");
const roleRoutes = require("./src/Routes/RoleRoutes");
const passport = require("./src/Utils/PassportUtil");

app.use("/auth", safeSpaceAuthRoutes); // SafeSpace auth routes
app.use("/original-auth", authRoutes); // Original auth routes
app.use("/users", userRoutes);
app.use("/role", roleRoutes);
app.use("/upload", uploadRoutes); // for file upload

// API routes for saved threats and notifications
app.use("/api", safeSpaceAuthRoutes);
